...
export function PortoCard({item, onClick, onDelete}: cardProps) {
          ...
          <div  className="w-full h-87 relative overflow-hidden rounded-lg cursor-pointer" onClick={onClick }>
                        ...
                        <div className="hover:opacity-100 opacity-0 transition ease-in-out absolute inset-0 flex flex-col justify-end p-6"
                            ...
                            <div>
                                ...
                                <Icon icon="mdi:trash" className="text-red-500 text-xl cursor-pointer hover:text-red-700 transition-colors duration-200" onClick={onDelete}/>
                            </div>
                        </div>
                         <Image
                            loading="lazy"
